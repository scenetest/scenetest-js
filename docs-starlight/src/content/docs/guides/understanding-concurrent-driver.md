---
title: Understanding the Concurrent Driver
description: How the concurrent-actor drain model works and why it makes multi-actor specs simpler and more reliable.
---
