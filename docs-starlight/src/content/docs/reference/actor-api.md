---
title: Actor API Reference
description: Complete reference for actor methods including navigation, visibility, interaction, scope, conditionals, and coordination.
---
