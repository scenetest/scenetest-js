...
.scenetest-cls-section {
  margin: 4px 8px;
  border: 1px solid #4a3a1a;
  border-radius: 6px;
  overflow: hidden;
}
.scenetest-cls-header {
  padding: 6px 10px;
  background: #2a2518;
  display: flex;
  justify-content: space-between;
...
.scenetest-cls-header:hover {
  background: #332d1e;
}
.scenetest-cls-summary {
  display: flex;
  gap: 8px;
  align-items: center;
}
...
.scenetest-cls-stat.flash {
  background: #3a2a0a;
  color: #f59e0b;
}
.scenetest-cls-stat.shift {
  background: #2a2a3a;
  color: #c4b5fd;
}
.scenetest-cls-items {
...
.scenetest-cls-section.collapsed .scenetest-cls-items {
  display: none;
}
.scenetest-item.cls-event {
  border-bottom-color: #2a2518;
}
.scenetest-item.cls-event .scenetest-icon.cls {
  background: #f59e0b;
  color: #1a1a2e;
  font-size: 12px;
}
...
/* CLS tracking fullscreen styles */
.count.cls {
  background: #3a2a0a;
  color: #f59e0b;
}
...
.location-row.cls-location:hover {
  background: #2a2518;
}
.location-desc.cls {
  color: #f59e0b;
